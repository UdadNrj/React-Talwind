  ...
  return (
    <div>
      ...
      <div className='flex flex-wrap items-center justify-center'>
        {
          products.map((x) => (
            <Link to={`/Catalogo/${x.id}`} class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2 cursor hover:mas-w-md">
                <a href="#">
